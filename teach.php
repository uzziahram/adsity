...
<head>
	...
	<title>Teach on Adsity - Become an Instructor</title>
...
<body class="auth-page">
	...
	<header class="navbar">
		...
		<div class="nav-right">
			<a href="teach.php" class="teach-link" style="color: var(--primary-blue); font-weight: 700;">Teach on Adsity</a>
	...
	<main class="auth-split-wrapper">
		...
		<div class="auth-image-side">
			<img src="./assets/instructor_sign_up.jpg" alt="Teach on Adsity Studio" class="auth-image-hero-bg">
			<div class="auth-image-overlay" style="background: linear-gradient(180deg, rgba(7, 23, 39, 0.4) 0%, rgba(7, 23, 39, 0.1) 40%, rgba(7, 23, 39, 0.88) 100%);"></div>
			...
			<div class="auth-image-bottom">
				<div class="auth-image-glass-card">
					<h2 class="auth-image-card-title">Adsity Instructor Studio</h2>
					<p class="auth-image-card-desc">Publish multi-video tech courses, reach thousands of global learners, and earn revenue from automated sponsor ad breaks.</p>
					<div class="auth-image-card-badges">
						<span class="auth-image-card-badge">💰 Ad Revenue Sharing</span>
						<span class="auth-image-card-badge">📹 Multi-Video Builder</span>
						<span class="auth-image-card-badge">⏱️ Auto-Duration Detection</span>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="auth-form-side">
			<div class="auth-form-container">
				<div class="auth-form-header">
					<h2 class="auth-title">Apply as an Instructor</h2>
					<p class="auth-subtitle">Fill in your profile details to set up your Instructor Studio account.</p>
				</div>

				<?php if ($status === 'success'): ?>
					<div class="alert alert--success">
						<img src="./assets/icons/check-circle.svg" width="20" height="20" alt="Success">
						<span><?= htmlspecialchars($message ?? 'Instructor registered successfully!') ?></span>
					</div>
				...
				<form action="teach_function.php" method="POST" class="auth-form">
					...
					<label class="form-checkbox-label">
						...
						<span>I agree to Adsity's <a href="#">Instructor Terms</a> &amp; <a href="#">Revenue Share Agreement</a></span>
					</label>

					<button type="submit" name="teach" class="btn-auth-submit btn-auth-submit--blue">
				...
				<div class="auth-form-footer">
					Want to learn instead? <a href="signup.php">Sign up as a Student</a> &bull; <a href="login.php">Log In</a>
				</div>
			</div>
		</div>
	</main>
