	...
	<main class="auth-wrapper">
		...
		<div class="auth-card" style="max-width: 520px;">
			...
			<div class="auth-card__header">
				...
				<h1 class="auth-title">Teach on Adsity</h1>
				<p class="auth-subtitle">Publish courses funded by ad breaks, build your audience, and earn passive revenue.</p>
			</div>
			...
			<form action="teach_function.php" method="POST" class="auth-form">
				...
				<button type="submit" name="teach" class="btn-auth-submit" style="background-color: #0284c7;">
					Apply as Instructor
